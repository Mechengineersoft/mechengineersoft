 ...
 */
export const submitContact = async (contactInquiryInput: ContactInquiryInput, options?: Parameters<typeof customFetch>[1]): Promise<SubmissionStatus> => {

  return customFetch<SubmissionStatus>(getSubmitContactUrl(),
  {
    ...options,
    method: 'POST',
...
export const getSubmitContactMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<ContactInquiryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<ContactInquiryInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitContact>>, {data: BodyType<ContactInquiryInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitContactMutationBody = BodyType<ContactInquiryInput>
 ...
 */
export const subscribeNewsletter = async (newsletterSubscriptionInput: NewsletterSubscriptionInput, options?: Parameters<typeof customFetch>[1]): Promise<SubmissionStatus> => {

  return customFetch<SubmissionStatus>(getSubscribeNewsletterUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
