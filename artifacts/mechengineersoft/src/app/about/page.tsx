          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 id="who-we-are-heading" className="text-display font-extrabold text-foreground mb-6">{about.whoHeading}</h2>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  {about.whoParagraphs.map((paragraph) => <p key={paragraph}>{paragraph}</p>)}
                </div>
              </div>
                ...
                <div className="flex flex-col lg:flex-row gap-10 items-center lg:items-start">
                  ...
                  <div className="flex-shrink-0">
                    <div className="relative w-36 h-36 md:w-44 md:h-44">
                      ...
                      />
                      <div className="absolute inset-[4px] rounded-full overflow-hidden flex items-center justify-center text-4xl font-extrabold gradient-text" style={{ background: 'var(--card)' }} aria-label={`${about.founderName} portrait`}>
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    <div className="flex flex-wrap gap-2 justify-center lg:justify-start mb-3">
                      <span className="section-label">{about.founderLabel}</span>
                      <span className="text-muted-foreground text-xs font-mono-custom">·</span>
                      <span className="section-label" style={{ color: '#00C2FF' }}>{about.founderRole}</span>
                    </div>
                    ...
                    <div className="space-y-4 text-muted-foreground leading-relaxed text-sm md:text-base">
                      {about.founderBio.map((paragraph) => <p key={paragraph}>{paragraph}</p>)}
                      <blockquote
                      ...
                      <p
                        ...
                        style={{ color: '#00C2FF' }}
                      >
                        — {about.founderName}, {about.founderLabel}
                      </p>
                    </div>
                ...
                {mvCards.map((card, i) => (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-xl font-extrabold text-foreground mb-3">{card.type === 'Mission' ? about.missionHeadline : about.visionHeadline}</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">{card.type === 'Mission' ? about.missionBody : about.visionBody}</p>
                    </div>
                  </div>
                ))}
              </div>
